...
void main() {
  ...
  // soft edge dimming (kept light so the field never goes murky)
...
const DEFAULT_COLORS = ["#A77AF4", "#7C45E8", "#4C1D95", "#241063"];

/**
 * Velaris (21st.dev) — an animated simplex-noise WebGL gradient with colour
 * blending, vignette and film grain. Defaults recoloured to the Meridius purple.
 */
