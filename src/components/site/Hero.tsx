...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto grid min-h-[680px] max-w-7xl grid-cols-1 items-start gap-10 px-6 pb-20 pt-[108px] sm:px-8 lg:min-h-[760px] lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg:items-start lg:gap-6">
        {/* Copy — left */}
        <motion.div
