...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto grid min-h-[860px] max-w-7xl grid-cols-1 items-center gap-10 px-6 pb-24 pt-24 sm:px-8 lg:min-h-[940px] lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg:gap-6">
        {/* Copy — left */}
        <motion.div
